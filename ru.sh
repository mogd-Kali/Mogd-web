...
show_menu() {
    ...
    echo "      █         TON OS (Simple)    █"
    echo "      ██████████████████████████████"
    echo -e "${RED}1.показать дату${NC}"
    echo -e "${RED}2. Показать список файлов в директории${NC}"
    echo -e "${RED}3. Выполнить команду echo${NC}"
    echo -e "${RED}4. Калькулятор${NC}"
    echo -e "${RED}5. Создать файл${NC}"
    echo -e "${RED}6. Удалить файл${NC}"
    echo -e "${RED}7. Переместить файл${NC}"
    echo -e "${RED}8. Просмотреть содержимое keyostonos.md${NC}"
    echo -e "${RED}9. Вывести дерево файлов${NC}"
    echo -e "${RED}10. Скачать файл (wget)${NC}"
    echo -e "${RED}11. Перейти на сайт TON OS${NC}"
    echo -e "${RED}12. Создать директорию programs${NC}"
    echo -e "${RED}13. Командная строка${NC}"
    echo -e "${RED}14. Магазин Пакетов${NC}"
    echo -e "${RED}15. Просмотр Программ${NC}"
    echo -e "${RED}16. Запустить программу${NC}"
    echo -e "${RED}17. Выйти${NC}"
    echo "------------------------------------"
